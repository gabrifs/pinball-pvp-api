...
├── Services/      # Application services (user accounts, player records, password hashing, JWT issuing,
│                  #   refresh tokens, email delivery, global exception handler, health check, background maintenance)
