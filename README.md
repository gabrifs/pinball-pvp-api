...
├── Services/      # Application services (authentication, user accounts, player records, password hashing,
│                  #   JWT issuing, refresh tokens, email delivery, global exception handler, health check,
